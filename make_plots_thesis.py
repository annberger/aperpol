...
def make_pdfs(self, interactive=False, final=False, thesis = True):
...
#    TP_cat = Table.read(self.polanalysisdir + '/TP_cat_final.txt', format='ascii')
    ...
    for source in PI_cat:
        ...
        if source['ID'] == lastid:
            ...
            # Figure title
            fig.suptitle(id + ' ' + scode, size=titlesize+5)
            ...
            ax1_PI.set_title('PI + TP-contours', size=titlesize)
            ...
            ax1_PI.text(0.95,0.95, ax1_text, transform=ax1_PI.transAxes, fontsize=textboxfont, verticalalignment='top', horizontalalignment='right', bbox=tb_props)
            ...
            grat_pi.setp_ticklabel(plotaxis=['left'], fontsize=fonts)
            ...
            ax2_TP.set_title('TP + PI-contours', size=titlesize)
            ax2_text = 'TP = ' + str(np.around(tp * 1000.0, decimals=2)) + '$\pm$' + str(np.around(tp_err * 1000.0, decimals=2)) + ' mJy'
            ax2_TP.text(0.95, 0.95, ax2_text, transform=ax2_TP.transAxes, fontsize=textboxfont, verticalalignment='top', horizontalalignment='right', bbox=tb_props)
    ...
    #                annim_tp.Marker(pos=str(new_ra_dec_main[0]) + ' deg ' + str(new_ra_dec_main[1]) + ' deg', marker='$' + str(int(tp_id)) + '$', color='cyan', markersize=ms_main, markeredgewidth=0.01)
            ...
            grat_tp.setp_axislabel(plotaxis=[0, 1], fontsize=fonts, visible=False)
            ...
            ax3_RM.set_title('RM + PI-contours', size=titlesize)
            ...
            ax3_RM.text(0.95, 0.95, ax3_text, transform=ax3_RM.transAxes, fontsize=textboxfont, verticalalignment='top', horizontalalignment='right', bbox=tb_props)
            grat_rm = annim_rm.Graticule()
            grat_rm.setp_gratline(visible=False)
            grat_rm.setp_axislabel(plotaxis=[0, 1], fontsize=fonts, visible=False)
            ...
            colorbar_rmframe = fig.add_axes((0.81,0.67,0.14,0.008))
            colbar_rm = annim_rm.Colorbar(fontsize=fonts, orientation='horizontal', frame=colorbar_rmframe)
            units_rm = 'Rotation Measure [rad/m$^2$]'
            colbar_rm.set_label(label=units_rm, fontsize = cbarfont, labelpad=-40)
            annim_rm.Image()
            annim_rm.plot()
            piim.plot()
            ...
            ax4_FP.set_title('FP + PI-contours', size=titlesize)
            ...
            ax4_FP.text(0.95, 0.95, ax4_text, transform=ax4_FP.transAxes, fontsize=textboxfont, verticalalignment='top', horizontalalignment='right', bbox=tb_props)
            grat_fp = annim_fp.Graticule()
            grat_fp.setp_gratline(visible=False)
            grat_fp.setp_axislabel(plotaxis=[0], fontsize=fonts2)
            grat_fp.setp_axislabel(plotaxis=[1], visible=False)
            grat_fp.setp_ticklabel(plotaxis=['left'] , fontsize=fonts)
            ...
            colbar_fp = annim_fp.Colorbar(fontsize=fonts, orientation='horizontal', frame=colorbar_fpframe)
            units_fp = 'Fractional Polarisation'
            colbar_fp.set_label(label=units_fp, fontsize=cbarfont, labelpad=-40)
            annim_fp.Image()
            annim_fp.plot()
            piim.plot()
            ...
            ax5_WISE3_4.set_title('WISE 3.4 $\mu$m + TP-contours', size=titlesize)
            ...
            if wise_id == 'nan':
                ...
                ax5_WISE3_4.text(0.95, 0.95, ax5_text, transform=ax5_WISE3_4.transAxes, fontsize=textboxfont, verticalalignment='top', horizontalalignment='right', bbox=tb_props)
            grat_wise3_4 = annim_wise3_4.Graticule()
            grat_wise3_4.setp_gratline(visible=False)
            grat_wise3_4.setp_axislabel(plotaxis=[0, 1], fontsize=fonts, visible=False)
            ...
            ax6_WISE4_6.set_title('WISE 4.6 $\mu$m + TP-contours', size=titlesize)
            ...
            if wise_id == 'nan':
                ...
                ax6_WISE4_6.text(0.95, 0.95, ax6_text, transform=ax6_WISE4_6.transAxes, fontsize=textboxfont, verticalalignment='top', horizontalalignment='right', bbox=tb_props)
            grat_wise4_6 = annim_wise4_6.Graticule()
            grat_wise4_6.setp_gratline(visible=False)
            grat_wise4_6.setp_axislabel(plotaxis=[0, 1], fontsize=fonts, visible=False)
            ...
            ax7_SDSS.set_title('SDSS G + TP-contours', size=titlesize)
            ...
            if np.isnan(sdss_ra):
                ...
                ax7_SDSS.text(0.95, 0.95, ax7_text, transform=ax7_SDSS.transAxes, fontsize=textboxfont, verticalalignment='top', horizontalalignment='right', bbox=tb_props)
            grat_sdss = annim_sdss.Graticule()
            grat_sdss.setp_gratline(visible=False)
            grat_sdss.setp_axislabel(visible=False)
            grat_sdss.setp_ticklabel(plotaxis=['bottom', 'left'], fontsize=fonts, visible=True)
            ...
            ax8_WISE12.set_title('WISE 12 $\mu$m + TP-contours', size=titlesize)
            ...
            if wise_id == 'nan':
                ...
                ax8_WISE12.text(0.95, 0.95, ax8_text, transform=ax8_WISE12.transAxes, fontsize=textboxfont, verticalalignment='top', horizontalalignment='right', bbox=tb_props)
            grat_wise12 = annim_wise12.Graticule()
            grat_wise12.setp_gratline(visible=False)
            grat_wise12.setp_axislabel(plotaxis=[0], fontsize=fonts, visible=False)
            grat_wise12.setp_axislabel(plotaxis=[1], fontsize=fonts2)
            grat_wise12.setp_ticklabel(plotaxis=['left'], visible=False)
            grat_wise12.setp_ticklabel(plotaxis=['bottom'], fontsize = fonts)
            ...
            ax9_WISE22.set_title('WISE 22 $\mu$m + TP-contours', size=titlesize)
            ...
            if wise_id == 'nan':
                ...
                ax9_WISE22.text(0.95, 0.95, ax9_text, transform=ax9_WISE22.transAxes, fontsize=textboxfont, verticalalignment='top', horizontalalignment='right', bbox=tb_props)
            grat_wise22 = annim_wise22.Graticule()
            grat_wise22.setp_gratline(visible=False)
            grat_wise22.setp_axislabel(plotaxis=[0,1], fontsize=fonts, visible=False)
            grat_wise22.setp_ticklabel(plotaxis=['left'], visible=False)
            grat_wise22.setp_ticklabel(plotaxis=['bottom'], fontsize = fonts)
    ...
    os.system('rm -rf ' + self.polanalysisplotdir + '/*_cutout.fits', bbox_inches='tight')
