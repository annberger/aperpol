    ...
    for source in PI_cat:
        ...
        if source['ID'] == lastid:
            ...
            try:
                ...
                ra = np.float(source['RA'])
                dec = np.float(source['DEC'])
                id = source['ID']
                scode = source['S_Code']
                pi = np.float(source['PI'])
                pi_err = np.float(source['PI_err'])
                tp_id = source['TP_ID']
                tp_ra = np.float(source['RA_TP'])
                tp_dec = np.float(source['DEC_TP'])
                tp = np.float(source['TP'])
                tp_err = np.float(source['TP_err'])
                rm = np.float(source['RM_Comp'])
                rm_err = np.float(source['RM_Comp_err'])
                fp = np.float(source['FP'])
                fp_err = np.float(source['FP_err'])
                nvss_ra = np.float(source['NVSS_RA'])
                nvss_dec = np.float(source['NVSS_DEC'])
                nvss_pi = np.float(source['NVSS_PI'])
                nvss_pi_err = np.float(source['NVSS_PI_err'])
                nvss_rm = np.float(source['NVSS_RM'])
                nvss_rm_err = np.float(source['NVSS_RM_err'])
                nvss_fp = np.float(source['NVSS_FP'])
                nvss_fp_err = np.float(source['NVSS_FP_err'])
                wise_id = source['WISE_ID']
                wise_ra = np.float(source['WISE_RA'])
                wise_dec = np.float(source['WISE_DEC'])
                wise_flux_3_4 = np.float(source['WISE_Flux_3.4'])
                wise_flux_3_4_err = np.float(source['WISE_Flux_3.4_err'])
                wise_flux_4_6 = np.float(source['WISE_Flux_4.6'])
                wise_flux_4_6_err = np.float(source['WISE_Flux_4.6_err'])
                wise_flux_12 = np.float(source['WISE_Flux_12'])
                wise_flux_12_err = np.float(source['WISE_Flux_12_err'])
                wise_flux_22 = np.float(source['WISE_Flux_22'])
                wise_flux_22_err = np.float(source['WISE_Flux_22_err'])
                sdss_id = source['SDSS_ID']
                sdss_ra = np.float(source['SDSS_RA'])
                sdss_dec = np.float(source['SDSS_DEC'])
                sdss_flux_u = np.float(source['SDSS_Flux_U'])
                sdss_flux_u_err = np.float(source['SDSS_Flux_U_err'])
                sdss_flux_g = np.float(source['SDSS_Flux_G'])
                sdss_flux_g_err = np.float(source['SDSS_Flux_G_err'])
                sdss_flux_r = np.float(source['SDSS_Flux_R'])
                sdss_flux_r_err = np.float(source['SDSS_Flux_R_err'])
                sdss_flux_i = np.float(source['SDSS_Flux_I'])
                sdss_flux_i_err = np.float(source['SDSS_Flux_I_err'])
                sdss_flux_z = np.float(source['SDSS_Flux_Z'])
                sdss_flux_z_err = np.float(source['SDSS_Flux_Z_err'])
                sdss_z = np.float(source['SDSS_z'])
                sdss_z_err = np.float(source['SDSS_z_err'])
